...
const HeroSection: React.FC = () => {
    ...
    return (
        <section
            ...
            style={{
                backgroundImage: "url('/images/kids-stand.jpeg')",
        ...
        >
            ...
            <div className="relative z-10 px-7">
                ...
                <h1 className="text-5xl md:text-6xl font-bold font-serif mb-4">Houston professional ballet instructor</h1>
                <p className="text-lg md:text-xl font-light mb-8">20+ years of experience</p>
                <p className="text-lg md:text-xl font-light mb-8">Private and group classes for children, adults & professionals</p>
                <button
