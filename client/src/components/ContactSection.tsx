...
import { FaPhone, FaEnvelope, FaMapMarkerAlt, FaWhatsapp, FaFacebookF } from 'react-icons/fa';
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="flex items-start">
                                        ...
                                        <div>
                                            <p className="font-medium">
                                                <a
                                                    href="https://www.facebook.com/sophiadancepage"
                                                    target="_blank"
                                                    rel="noopener noreferrer"
                                                    className="hover:text-[#8B7355] transition-colors"
                                                >
                                            ...
                                            <p className="text-xs mt-1 text-gray-500">Message or follow us</p>
                                        </div>
                                    </div>
